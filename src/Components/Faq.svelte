<script>
  const questions = [
    {
      title: "Wait, why I can't search tutorials on youtube.",
      answer:
  ...
  <div class="lg:w-10/12 flex flex-wrap justify-between">
    {#each questions as question}
      <div class="py-4 lg:w-1/2 lg:px-10">
        <p class="italic text-2xl text-gray-900 py-2">{question.title}</p>
        <p class="text-gray-800 text-xl">{question.answer}</p>
      </div>
    {/each}
  </div>
</section>
