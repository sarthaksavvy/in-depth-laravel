<section>
  <div
    class="shadow-md py-24 px-4 bg-repeat bg-fixed justify-center flex-wrap
    transform -skew-y-3"
    ...
    <div class="py-4 text-black flex flex-wrap flex-grow">
      <div class="text-center w-full md:w-4/12">
        ...
        <div class="py-4 flex justify-center">
          <a
            ...
            class="twitter-follow-button shadow-lg"
      ...
      <div class="w-full md:w-7/12 text-xl">
        <p class="p-2">
          Hii, I'm Sarthak Shrivastava, founder of{' '}
          <a href="https://bitfumes.com" class="link">Bitfumes</a>
          , a full stack developer, passionate speaker and online instructor.
        </p>
        <p class="p-2 md:p-4">
          For the last 4 years, I'm teaching Laravel and web development related
          stuffs on{' '}
          <a href="https://youtube.com/bitfumes" class="link">youtube{' '}</a>
        ...
        <p class="p-2 md:p-4">
          ...
          <a href="https://github.com/sarthaksavvy" class="link">
            open source package
          </a>
          .
        </p>
